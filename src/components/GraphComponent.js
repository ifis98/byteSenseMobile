      ...
      <View style={styles.container}>
        ...
        {color === '#00BE2A' && (
          <Text style={styles.graphText}>
            ...
            this week. Your highest Byte Score was{' '}
            <Text style={styles.lowText}>65</Text> on{' '}
            <Text style={styles.lowText}>Friday.</Text>
          </Text>
        )}
        {color === '#FF8B02' && (
          <Text style={styles.graphText}>
            You had a <Text style={styles.lowText}>High</Text> number of bruxism
            episodes this week. Your highest number of episodes was{' '}
            <Text style={styles.lowText}>7</Text> on{' '}
            <Text style={styles.lowText}>Friday</Text>
          </Text>
        )}
      </View>
